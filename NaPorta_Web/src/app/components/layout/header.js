  ...
  return (
    <header class='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
      <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
        <a
          href='/'
          className='hover:text-[#000000] text-[#FF0000] block font-bold text-[20px]'
        >
          Naporta
        </a>
        ...
        >
          ...
          <ul class='lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
            ...
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
              <a
                href='/'
                class='hover:text-[#00000] text-[#FF0000] block font-semibold text-[15px]'
              >
                Home
              </a>
            </li>
        ...
        <div class='flex max-lg:ml-auto space-x-4'>
          {/* <button class='px-4 py-2 text-sm rounded-full font-bold text-gray-500 border-2 bg-transparent hover:bg-gray-50 transition-all ease-in-out duration-300'>
            Login
          </button> */}
          <a href='/register'>
            <button class='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-[#FF0000] bg-[#FF0000] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#FF0000]'>
              Registrar
            </button>
          </a>
